/**
 * Prisma-backed audit sink - for hazeljs projects using @hazeljs/prisma
 */
...
import { computeTraceHash } from '../integrity/hashChain';
...
/** Audit sink backed by Prisma - use with @hazeljs/prisma PrismaService */
export class PrismaAuditSink implements AuditSink {
  private table: string;

  constructor(private options: PrismaAuditSinkOptions) {
